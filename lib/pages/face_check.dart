...
class _FaceCheckState extends State<FaceCheck> {
  ...
  _cropImage() {
    ...
    setState(() {
      faceCrop = img.copyCrop(originalImage, faceMaps[0]['x'], faceMaps[0]['y'],
          faceMaps[0]['w'], faceMaps[0]['h']);

      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => DisplayPicture(image: faceCrop)));
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Face Detection', style: TextStyle(color: Colors.white))),
      body: Container(
